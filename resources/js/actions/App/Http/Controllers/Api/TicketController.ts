...
* @see app/Http/Controllers/Api/TicketController.php:19
* @route '/api/tickets'
*/
...
* @see app/Http/Controllers/Api/TicketController.php:50
* @route '/api/tickets'
*/
...
* @see app/Http/Controllers/Api/TicketController.php:62
...
* @see app/Http/Controllers/Api/TicketController.php:72
* @route '/api/tickets/{ticket}'
*/
...
* @route '/api/tickets/{ticket}'
*/
update.patch = (args: { ticket: string | number | { id: string | number } } | [ticket: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
...
* @route '/api/tickets/{ticket}'
*/
updateForm.patch = (args: { ticket: string | number | { id: string | number } } | [ticket: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: update.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
* @see app/Http/Controllers/Api/TicketController.php:79
* @route '/api/tickets/{ticket}'
*/
