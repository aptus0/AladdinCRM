...
/**
* @see \App\Http\Controllers\Api\QuoteController::exportPdf
* @see app/Http/Controllers/Api/QuoteController.php:81
* @route '/api/quotes/{quote}/pdf'
*/
export const exportPdf = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/quotes/{quote}/pdf'
*/
exportPdf.url = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
...
* @route '/api/quotes/{quote}/pdf'
*/
exportPdf.get = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: exportPdf.url(args, options),
    method: 'get',
})
...
* @route '/api/quotes/{quote}/pdf'
*/
exportPdf.head = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: exportPdf.url(args, options),
    method: 'head',
})
...
* @route '/api/quotes/{quote}/pdf'
*/
const exportPdfForm = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/quotes/{quote}/pdf'
*/
exportPdfForm.get = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: exportPdf.url(args, options),
    method: 'get',
})
...
* @route '/api/quotes/{quote}/pdf'
*/
exportPdfForm.head = (args: { quote: string | number | { id: string | number } } | [quote: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const QuoteController = { exportPdf, index, store, show, update, destroy }
